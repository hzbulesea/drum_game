...
public class PlaygroundActivity8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playground8);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.m8_visit_near_the_river);
//        mediaPlayer.start();
        ...
        back_btn.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction()==MotionEvent.ACTION_UP){
                    ...
                    Intent intent = new Intent(PlaygroundActivity8.this, ScoreActivity.class);
