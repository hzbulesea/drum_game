...
public class PlaygroundActivity6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playground6);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.m6_snowing);
//        mediaPlayer.start();
        ...
        back_btn.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction()==MotionEvent.ACTION_UP){
                    ...
                    Intent intent = new Intent(PlaygroundActivity6.this, ScoreActivity.class);
