...
public class PlaygroundActivity7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playground7);
        ...
        mediaPlayer = MediaPlayer.create(this, R.raw.m7_whynot);
//        mediaPlayer.start();
        ...
        back_btn.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if(motionEvent.getAction()==MotionEvent.ACTION_UP){
                    ...
                    Intent intent = new Intent(PlaygroundActivity7.this, ScoreActivity.class);
